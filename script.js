...
function updateBestScore(){
  bestScoreArray.forEach((score, index)=>{
    ...
    if(questionAmount==score.questions){
      // Return the score as a number with one decimal
...
function scoresToDOM(){
  ...
  updateBestScore()
  // Reset item conatiner, scroll to the top and go to top
...
function checkTime(){
  ...
  if(playerGuessArray.length ==questionAmount){
    ...
    equationsArray.forEach((eqn, index)=>{
       
      if(eqn.evaluated===playerGuessArray[index]){
...
// Scroll, store the user selection in payerGuessArray
...
// Get random number up t a max number
...
function createEquations() {
  ...
  console.log('wrongg questions :', wrongEquations ,'\n')
...
function equationsToDOM(){
  ...
  equationsArray.forEach((eqn)=>{
    ...
    equationText.textContent=eqn.value
    // Append
...
//  Navigate fromsplash page to countdown page
